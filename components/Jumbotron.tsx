...
function Jumbotron(props: Props) {
  return (
    <section
      className={`shadow-jumbotron bg-top bg-no-repeat bg-contain bg-[url('/assets/background_xs.jpg')] sm:bg-[url('/assets/background_xs.jpg')] lg:bg-[url('/assets/background.jpg')] bg-white bg-blend-multiply`}
    >
